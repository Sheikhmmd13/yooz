...
CategoriesContainer.querySelector("#iconDown").addEventListener("click", () => {
	CategoriesContainer.querySelector("#iconDown").classList.toggle("rotate");
	CategoriesContainer.querySelector(".categorie-links").classList.toggle(
		"hidden"
	);
});
...
PriceFilterRange.querySelector("#iconDown").addEventListener("click", () => {
	PriceFilterRange.querySelector("#iconDown").classList.toggle("rotate");
	PriceFilterRange.querySelector(".price-range-container").classList.toggle(
		"hidden"
	);
});
